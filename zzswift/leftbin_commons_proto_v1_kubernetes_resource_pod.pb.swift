...
/// kubernetes pod
public struct Leftbin_Commons_Proto_V1_Kubernetes_Resource_Pod {
  ...
  public var containers: [Leftbin_Commons_Proto_V1_Kubernetes_Resource_PodContainer] = []
...
public struct Leftbin_Commons_Proto_V1_Kubernetes_Resource_PodContainer {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Leftbin_Commons_Proto_V1_Kubernetes_Resource_Pods {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var entries: [Leftbin_Commons_Proto_V1_Kubernetes_Resource_Pod] = []
...
/// workload pods
public struct Leftbin_Commons_Proto_V1_Kubernetes_Resource_WorkloadPods {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  ///all pods with workload=microservice in a hosting environment are included.
  public var microservicePods: [Leftbin_Commons_Proto_V1_Kubernetes_Resource_Pod] = []

  ///postgres cluster pods include all ancillary pods associated with the postgres cluster including entity-operator etc
  public var postgresClusterPods: [Leftbin_Commons_Proto_V1_Kubernetes_Resource_Pod] = []

  ///kafka cluster pods include all ancillary pods associated with the kafka cluster including schema-registry, kowl etc
  public var kafkaClusterPods: [Leftbin_Commons_Proto_V1_Kubernetes_Resource_Pod] = []
...
extension Leftbin_Commons_Proto_V1_Kubernetes_Resource_Pod: @unchecked Sendable {}
extension Leftbin_Commons_Proto_V1_Kubernetes_Resource_PodContainer: @unchecked Sendable {}
extension Leftbin_Commons_Proto_V1_Kubernetes_Resource_Pods: @unchecked Sendable {}
extension Leftbin_Commons_Proto_V1_Kubernetes_Resource_WorkloadPods: @unchecked Sendable {}
#endif  // swift(>=5.5) && canImport(_Concurrency)

// MARK: - Code below here is support for the SwiftProtobuf runtime.

fileprivate let _protobuf_package = "leftbin.commons.proto.v1.kubernetes.resource"

extension Leftbin_Commons_Proto_V1_Kubernetes_Resource_Pod: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Leftbin_Commons_Proto_V1_Kubernetes_Resource_Pod, rhs: Leftbin_Commons_Proto_V1_Kubernetes_Resource_Pod) -> Bool {
...
extension Leftbin_Commons_Proto_V1_Kubernetes_Resource_PodContainer: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Leftbin_Commons_Proto_V1_Kubernetes_Resource_PodContainer, rhs: Leftbin_Commons_Proto_V1_Kubernetes_Resource_PodContainer) -> Bool {
...
extension Leftbin_Commons_Proto_V1_Kubernetes_Resource_Pods: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Leftbin_Commons_Proto_V1_Kubernetes_Resource_Pods, rhs: Leftbin_Commons_Proto_V1_Kubernetes_Resource_Pods) -> Bool {
...
extension Leftbin_Commons_Proto_V1_Kubernetes_Resource_WorkloadPods: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Leftbin_Commons_Proto_V1_Kubernetes_Resource_WorkloadPods, rhs: Leftbin_Commons_Proto_V1_Kubernetes_Resource_WorkloadPods) -> Bool {
