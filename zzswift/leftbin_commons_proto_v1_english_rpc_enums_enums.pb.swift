...
public struct Leftbin_Commons_Proto_V1_English_Rpc_Enums_Word {
...
extension Leftbin_Commons_Proto_V1_English_Rpc_Enums_Word.WordEnum: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Leftbin_Commons_Proto_V1_English_Rpc_Enums_Word.WordEnum] = [
    .wordUnspecified,
    .app,
    .application,
    .aws,
...
/// this enum is encapsulated inside a message as a few entries like "name" (a reserved word in few languages) can only be added to the enum if it is inside a message.
/// the recommended best practice to prefix the entry with enum name has been intentionally ignored to as the values of the entries are intended to be used to name resources.
public struct Leftbin_Commons_Proto_V1_English_Rpc_Enums_Acronym {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Leftbin_Commons_Proto_V1_English_Rpc_Enums_Acronym.AcronymEnum: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Leftbin_Commons_Proto_V1_English_Rpc_Enums_Acronym.AcronymEnum] = [
    .acronymUnspecified,
    .nw,
    .rpc,
  ]
...
extension Leftbin_Commons_Proto_V1_English_Rpc_Enums_Word: @unchecked Sendable {}
extension Leftbin_Commons_Proto_V1_English_Rpc_Enums_Word.WordEnum: @unchecked Sendable {}
extension Leftbin_Commons_Proto_V1_English_Rpc_Enums_Acronym: @unchecked Sendable {}
extension Leftbin_Commons_Proto_V1_English_Rpc_Enums_Acronym.AcronymEnum: @unchecked Sendable {}
#endif  // swift(>=5.5) && canImport(_Concurrency)

// MARK: - Code below here is support for the SwiftProtobuf runtime.

fileprivate let _protobuf_package = "leftbin.commons.proto.v1.english.rpc.enums"

extension Leftbin_Commons_Proto_V1_English_Rpc_Enums_Word: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Leftbin_Commons_Proto_V1_English_Rpc_Enums_Word, rhs: Leftbin_Commons_Proto_V1_English_Rpc_Enums_Word) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Leftbin_Commons_Proto_V1_English_Rpc_Enums_Word.WordEnum: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Leftbin_Commons_Proto_V1_English_Rpc_Enums_Acronym: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Leftbin_Commons_Proto_V1_English_Rpc_Enums_Acronym, rhs: Leftbin_Commons_Proto_V1_English_Rpc_Enums_Acronym) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Leftbin_Commons_Proto_V1_English_Rpc_Enums_Acronym.AcronymEnum: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
