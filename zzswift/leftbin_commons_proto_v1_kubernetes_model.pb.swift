...
public struct Leftbin_Commons_Proto_V1_Kubernetes_Container {
  ...
  public var ports: [Leftbin_Commons_Proto_V1_Kubernetes_ContainerPort] = []

  public var resources: Leftbin_Commons_Proto_V1_Kubernetes_ContainerResources {
    get {return _resources ?? Leftbin_Commons_Proto_V1_Kubernetes_ContainerResources()}
  ...
  public var env: [Leftbin_Commons_Proto_V1_Kubernetes_ContainerEnvVar] = []

  public var unknownFields = SwiftProtobuf.UnknownStorage()

  public init() {}

  fileprivate var _resources: Leftbin_Commons_Proto_V1_Kubernetes_ContainerResources? = nil
}

/// kubernetes container cpu and memory resources
public struct Leftbin_Commons_Proto_V1_Kubernetes_ContainerResources {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var limits: Leftbin_Commons_Proto_V1_Kubernetes_CpuMemory {
    get {return _limits ?? Leftbin_Commons_Proto_V1_Kubernetes_CpuMemory()}
  ...
  public var requests: Leftbin_Commons_Proto_V1_Kubernetes_CpuMemory {
    get {return _requests ?? Leftbin_Commons_Proto_V1_Kubernetes_CpuMemory()}
  ...
  fileprivate var _limits: Leftbin_Commons_Proto_V1_Kubernetes_CpuMemory? = nil
  fileprivate var _requests: Leftbin_Commons_Proto_V1_Kubernetes_CpuMemory? = nil
}

public struct Leftbin_Commons_Proto_V1_Kubernetes_ContainerEnvVar {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Leftbin_Commons_Proto_V1_Kubernetes_ContainerPort {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Leftbin_Commons_Proto_V1_Kubernetes_CpuMemory {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Leftbin_Commons_Proto_V1_Kubernetes_Container: @unchecked Sendable {}
extension Leftbin_Commons_Proto_V1_Kubernetes_ContainerResources: @unchecked Sendable {}
extension Leftbin_Commons_Proto_V1_Kubernetes_ContainerEnvVar: @unchecked Sendable {}
extension Leftbin_Commons_Proto_V1_Kubernetes_ContainerPort: @unchecked Sendable {}
extension Leftbin_Commons_Proto_V1_Kubernetes_CpuMemory: @unchecked Sendable {}
#endif  // swift(>=5.5) && canImport(_Concurrency)

// MARK: - Code below here is support for the SwiftProtobuf runtime.

fileprivate let _protobuf_package = "leftbin.commons.proto.v1.kubernetes"

extension Leftbin_Commons_Proto_V1_Kubernetes_Container: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Leftbin_Commons_Proto_V1_Kubernetes_Container, rhs: Leftbin_Commons_Proto_V1_Kubernetes_Container) -> Bool {
...
extension Leftbin_Commons_Proto_V1_Kubernetes_ContainerResources: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Leftbin_Commons_Proto_V1_Kubernetes_ContainerResources, rhs: Leftbin_Commons_Proto_V1_Kubernetes_ContainerResources) -> Bool {
...
extension Leftbin_Commons_Proto_V1_Kubernetes_ContainerEnvVar: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Leftbin_Commons_Proto_V1_Kubernetes_ContainerEnvVar, rhs: Leftbin_Commons_Proto_V1_Kubernetes_ContainerEnvVar) -> Bool {
    if lhs.name != rhs.name {return false}
...
extension Leftbin_Commons_Proto_V1_Kubernetes_ContainerPort: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Leftbin_Commons_Proto_V1_Kubernetes_ContainerPort, rhs: Leftbin_Commons_Proto_V1_Kubernetes_ContainerPort) -> Bool {
    if lhs.name != rhs.name {return false}
...
extension Leftbin_Commons_Proto_V1_Kubernetes_CpuMemory: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Leftbin_Commons_Proto_V1_Kubernetes_CpuMemory, rhs: Leftbin_Commons_Proto_V1_Kubernetes_CpuMemory) -> Bool {
