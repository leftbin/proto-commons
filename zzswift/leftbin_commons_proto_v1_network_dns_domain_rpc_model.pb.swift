...
public struct Leftbin_Commons_Proto_V1_Network_Dns_Domain_Rpc_DnsDomain {
  ...
  public var visibility: Leftbin_Commons_Proto_V1_Network_Dns_Domain_Rpc_Enums_DnsDomainVisibility = .unspecified

  /// dns records to be added to the zone
  public var dnsRecords: [Leftbin_Commons_Proto_V1_Network_Dns_Record_Rpc_DnsRecord] = []
...
extension Leftbin_Commons_Proto_V1_Network_Dns_Domain_Rpc_DnsDomain: @unchecked Sendable {}
#endif  // swift(>=5.5) && canImport(_Concurrency)

// MARK: - Code below here is support for the SwiftProtobuf runtime.

fileprivate let _protobuf_package = "leftbin.commons.proto.v1.network.dns.domain.rpc"

extension Leftbin_Commons_Proto_V1_Network_Dns_Domain_Rpc_DnsDomain: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Leftbin_Commons_Proto_V1_Network_Dns_Domain_Rpc_DnsDomain, rhs: Leftbin_Commons_Proto_V1_Network_Dns_Domain_Rpc_DnsDomain) -> Bool {
